...
module "web_elb" {
  ...
  #subnets      = "subnet-07495618908f61d87"
...
module "web_asg" {
  ...
  #subnets               = "subnet-067ae213cb04aed83,subnet-07495618908f61d87,subnet-05c5d2bd1c4cdb6b4"
  subnets               = "${element(split(",", module.vpc.public_subnet_ids), 0)}"
...
module "rds" {
  ...
  #subnets             = ["subnet-00e63a48bdac128c2","subnet-0a7aaa8962b636fa6","subnet-06d197e15db8d4150"]
  subnets             =  ["${element(split(",", module.vpc.private_subnet_ids), 0)}","${element(split(",", module.vpc.private_subnet_ids),1)}"]
